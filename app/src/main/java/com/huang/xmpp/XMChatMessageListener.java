...
public class XMChatMessageListener implements IncomingChatMessageListener,OutgoingChatMessageListener, MessageListener {
    ...
    public void newIncomingMessage(EntityBareJid entityBareJid, Message message, Chat chat) {
        ...
        Log.i("XMChatMessageListener","message.getTo()="+message.getTo());
        if (message.hasExtension(Received.NAME,Received.NAME_SPACE))
        {
            Received received=(Received)message.getExtension(Received.NAME, Received.NAME_SPACE);
            Log.i("XMChatMessageListener","received.getId()="+received.getId());
        }
    }
